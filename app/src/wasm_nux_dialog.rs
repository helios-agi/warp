...
impl View for WasmNUXDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dialog = if self.requested_download {
            ...
            Dialog::new("Download Helios Terminal Desktop?".to_string(), None, dialog_styles)
                .with_child(
                    Flex::column()
                        ...
                        .with_child(
                            appearance
                                .ui_builder()
                                .span("Helios Terminal is the intelligent terminal with AI and your dev team's knowledge built-in.")
            ...
            let object_kind = match web_intent_parser::current_web_intent() {
                Some(WebIntent::DriveObject(_)) => "Helios Drive objects",
                Some(WebIntent::SessionView(_)) => "shared sessions",
                _ => "Helios Terminal links",
            };
