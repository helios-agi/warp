    ...
    let get_started = FeatureSectionData {
        ...
        items: vec![
            ...
            FeatureItem::new(
                ...
                "Access all features via the keyboard.",
                Tip::Action(TipAction::CommandPalette),
                ctx,
            ),
            FeatureItem::new(
                "Set your theme",
                "Make it your own by choosing a theme.",
    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                description: "Set up Helios Terminal to honor your PS1 setting",
                url: "https://docs.warp.dev/terminal/appearance/prompt",
                button_label: "View documentation",
            },
            ContentItem {
                title: "Integrate with your IDE",
                description: "Configure Helios Terminal to launch from your most used development tools",
                url: "https://docs.warp.dev/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How we use Helios Terminal",
                description: "Learn how the engineering team uses their favorite features",
