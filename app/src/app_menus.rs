...
const SHOW_SSH_COMMAND_BLOCKS_MENU_ITEM_NAME: &str = "Show SSH Blocks";
const HIDE_SSH_COMMAND_BLOCKS_MENU_ITEM_NAME: &str = "Hide SSH Blocks";
...
fn make_new_app_menu(ctx: &AppContext) -> Menu {
    ...
    menu_items.push(MenuItem::Custom(CustomMenuItem::new(
        "Set Helios as Default Terminal",
        move |ctx| {
    ...
    Menu::new("Helios Terminal", menu_items)
}
...
fn make_new_help_menu() -> Menu {
    Menu::new(
        ...
        vec![
            ...
            link_menu_item("Slack Community...", links::SLACK_URL.into()),
        ],
    )
}
