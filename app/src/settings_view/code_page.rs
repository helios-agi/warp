...
const CODEBASE_INDEX_DESCRIPTION: &str = "Helios indexes your codebases via Memgraph graph database and Pi's codebase indexer. Indexed projects enable semantic search, code navigation, and agent context retrieval.";
